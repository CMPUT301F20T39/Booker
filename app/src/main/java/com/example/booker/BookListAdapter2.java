...
public class BookListAdapter2 extends FirestoreRecyclerAdapter<Book, BookListAdapter2.BookHolder> {
    ...
    public BookListAdapter2(@NonNull FirestoreRecyclerOptions<Book> options,
    ...
    @NonNull
    @Override
    public BookListAdapter2.BookHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(layoutResource, parent, false);
        return new BookListAdapter2.BookHolder(v);
    }

    @Override
    protected void onBindViewHolder(@NonNull final BookListAdapter2.BookHolder holder, final int position, @NonNull final Book model) {
